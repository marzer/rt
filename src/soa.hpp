...
namespace rt
{
	class SOAGEN_EMPTY_BASES boxes //
		SOAGEN_HIDDEN_BASE(public soagen::mixins::erasable<boxes>,
						   public soagen::mixins::unordered_erasable<boxes>,
						   ...
						   public soagen::mixins::swappable<boxes>)
	{
	  ...
	  public:
		...
		boxes& push_back(column_traits<0>::param_type value,
			...
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<column_traits<0>::param_forward_type>(),
														 std::declval<column_traits<1>::param_forward_type>(),
														 std::declval<column_traits<2>::param_forward_type>(),
														 std::declval<column_traits<3>::param_forward_type>(),
														 std::declval<column_traits<4>::param_forward_type>(),
														 std::declval<column_traits<5>::param_forward_type>(),
														 std::declval<column_traits<6>::param_forward_type>(),
														 std::declval<column_traits<7>::param_forward_type>()))) //
		{
		...
		SOAGEN_CPP20_CONSTEXPR
		SOAGEN_ENABLE_IF_T(boxes&, sfinae)
		push_back(column_traits<0>::rvalue_type value,
			...
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<column_traits<0>::rvalue_forward_type>(),
														 std::declval<column_traits<1>::rvalue_forward_type>(),
														 std::declval<column_traits<2>::rvalue_forward_type>(),
														 std::declval<column_traits<3>::rvalue_forward_type>(),
														 std::declval<column_traits<4>::rvalue_forward_type>(),
														 std::declval<column_traits<5>::rvalue_forward_type>(),
														 std::declval<column_traits<6>::rvalue_forward_type>(),
														 std::declval<column_traits<7>::rvalue_forward_type>()))) //
		...
		boxes& push_back(const soagen::row<Table, Columns...>& row_)											  //
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<const soagen::row<Table, Columns...>&>()))) //
		...
		boxes& emplace_back(Value&& value,
							...
							ExtentsY&& extents_y,
							ExtentsZ&& extents_z) //
			noexcept(noexcept(std::declval<table_type&>().emplace_back(std::declval<Value&&>(),
																	   std::declval<Material&&>(),
																	   std::declval<CenterX&&>(),
																	   std::declval<CenterY&&>(),
																	   std::declval<CenterZ&&>(),
																	   std::declval<ExtentsX&&>(),
																	   std::declval<ExtentsY&&>(),
																	   std::declval<ExtentsZ&&>()))) //
		{
		...
		template <typename Table, size_t... Columns SOAGEN_ENABLE_IF(soagen::is_soa<soagen::remove_cvref<Table>>)>
		SOAGEN_CPP20_CONSTEXPR
		boxes& emplace_back(const soagen::row<Table, Columns...>& row_)											  //
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>)										  //
		{
		...
		SOAGEN_HIDDEN(template <bool sfinae = table_traits::all_move_constructible && table_traits::all_move_assignable>
		)
		SOAGEN_CPP20_CONSTEXPR
		SOAGEN_ENABLE_IF_T(boxes&, sfinae)
		insert(size_type index_,
			   ...
			   column_traits<7>::param_type extents_z) //
			noexcept(
				noexcept(std::declval<table_type&>().emplace(size_type{},
															 std::declval<column_traits<0>::param_forward_type>(),
															 std::declval<column_traits<1>::param_forward_type>(),
															 std::declval<column_traits<2>::param_forward_type>(),
															 std::declval<column_traits<3>::param_forward_type>(),
															 std::declval<column_traits<4>::param_forward_type>(),
		...
		SOAGEN_CPP20_CONSTEXPR
		boxes& insert(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_,
					  column_traits<0>::param_type value,
					  column_traits<1>::param_type material,
					  column_traits<2>::param_type center_x,
					  column_traits<3>::param_type center_y,
		...
		SOAGEN_CPP20_CONSTEXPR
		boxes& insert(size_type index_,
					  SOAGEN_ENABLE_IF_T(column_traits<0>::rvalue_type, sfinae) value,
					  column_traits<1>::rvalue_type material,
					  column_traits<2>::rvalue_type center_x,
					  column_traits<3>::rvalue_type center_y,
					  column_traits<4>::rvalue_type center_z,
			...
			noexcept(
				noexcept(std::declval<table_type&>().emplace(size_type{},
															 std::declval<column_traits<0>::rvalue_forward_type>(),
															 std::declval<column_traits<1>::rvalue_forward_type>(),
															 std::declval<column_traits<2>::rvalue_forward_type>(),
															 std::declval<column_traits<3>::rvalue_forward_type>(),
															 std::declval<column_traits<4>::rvalue_forward_type>(),
		...
		SOAGEN_CPP20_CONSTEXPR
		boxes& insert(const_iterator iter_,
					  column_traits<0>::rvalue_type value,
					  SOAGEN_ENABLE_IF_T(column_traits<1>::rvalue_type, sfinae) material,
					  column_traits<2>::rvalue_type center_x,
					  column_traits<3>::rvalue_type center_y,
					  column_traits<4>::rvalue_type center_z,
					  column_traits<5>::rvalue_type extents_x,
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		boxes& insert(size_type index_, const soagen::row<Table, Columns...>& row_)								 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		boxes& insert(const_iterator iter_, const soagen::row<Table, Columns...>& row_)							 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		emplace(size_type index_,
				...
				ExtentsY&& extents_y,
				ExtentsZ&& extents_z) //
			noexcept(noexcept(std::declval<table_type&>().emplace(size_type{},
																  std::declval<Value&&>(),
																  std::declval<Material&&>(),
																  std::declval<CenterX&&>(),
																  std::declval<CenterY&&>(),
		...
		template <typename Value,
				  ...
				  bool sfinae = table_traits::all_move_constructible&& table_traits::all_move_assignable>
		SOAGEN_CPP20_CONSTEXPR
		boxes& emplace(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_,
					   Value&& value,
					   Material&& material,
					   CenterX&& center_x,
					   CenterY&& center_y,
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		boxes& emplace(size_type index_, const soagen::row<Table, Columns...>& row_)							 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		boxes& emplace(const_iterator iter_, const soagen::row<Table, Columns...>& row_)						 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
...
namespace rt
{
	class SOAGEN_EMPTY_BASES materials //
		SOAGEN_HIDDEN_BASE(public soagen::mixins::erasable<materials>,
						   public soagen::mixins::unordered_erasable<materials>,
						   ...
						   public soagen::mixins::swappable<materials>)
	{
	  ...
	  public:
		...
		SOAGEN_HIDDEN(template <bool sfinae = table_traits::rvalue_type_list_is_distinct>)
		SOAGEN_CPP20_CONSTEXPR
		SOAGEN_ENABLE_IF_T(materials&, sfinae)
		push_back(column_traits<0>::rvalue_type colour)															  //
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<column_traits<0>::rvalue_forward_type>()))) //
			SOAGEN_REQUIRES(table_traits::rvalue_type_list_is_distinct)											  //
		{
		...
		materials& emplace_back(Colour&& colour)												   //
			noexcept(noexcept(std::declval<table_type&>().emplace_back(std::declval<Colour&&>()))) //
		{
		...
		template <typename Table, size_t... Columns SOAGEN_ENABLE_IF(soagen::is_soa<soagen::remove_cvref<Table>>)>
		SOAGEN_CPP20_CONSTEXPR
		materials& emplace_back(const soagen::row<Table, Columns...>& row_)										  //
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>)										  //
		{
		...
		SOAGEN_CPP20_CONSTEXPR
		SOAGEN_ENABLE_IF_T(materials&, sfinae)
		insert(size_type index_, column_traits<0>::param_type colour)											//
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<column_traits<0>::param_forward_type>()))) //
			SOAGEN_REQUIRES(table_traits::all_move_constructible&& table_traits::all_move_assignable)			//
		{
		...
		SOAGEN_CPP20_CONSTEXPR
		materials& insert(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_, column_traits<0>::param_type colour) //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<column_traits<0>::param_forward_type>())))	 //
			SOAGEN_REQUIRES(table_traits::all_move_constructible&& table_traits::all_move_assignable)			 //
		{
		...
		SOAGEN_CPP20_CONSTEXPR
		materials& insert(size_type index_, SOAGEN_ENABLE_IF_T(column_traits<0>::rvalue_type, sfinae) colour)	 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<column_traits<0>::rvalue_forward_type>()))) //
			SOAGEN_REQUIRES(table_traits::rvalue_type_list_is_distinct&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		{
		...
		SOAGEN_CPP20_CONSTEXPR
		materials& insert(const_iterator iter_, column_traits<0>::rvalue_type colour)							 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<column_traits<0>::rvalue_forward_type>()))) //
			SOAGEN_REQUIRES(table_traits::rvalue_type_list_is_distinct&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		materials& insert(const_iterator iter_, const soagen::row<Table, Columns...>& row_)						 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		SOAGEN_CPP20_CONSTEXPR
		SOAGEN_ENABLE_IF_T(materials&, sfinae)
		emplace(size_type index_, Colour&& colour)														   //
			noexcept(noexcept(std::declval<table_type&>().emplace(size_type{}, std::declval<Colour&&>()))) //
			SOAGEN_REQUIRES(table_traits::all_move_constructible&& table_traits::all_move_assignable)	   //
		{
		...
		template <typename Colour,
				  bool sfinae = table_traits::all_move_constructible&& table_traits::all_move_assignable>
		SOAGEN_CPP20_CONSTEXPR
		materials& emplace(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_, Colour&& colour)			   //
			noexcept(noexcept(std::declval<table_type&>().emplace(size_type{}, std::declval<Colour&&>()))) //
			SOAGEN_REQUIRES(table_traits::all_move_constructible&& table_traits::all_move_assignable)	   //
		{
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		materials& emplace(size_type index_, const soagen::row<Table, Columns...>& row_)						 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		materials& emplace(const_iterator iter_, const soagen::row<Table, Columns...>& row_)					 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
...
namespace rt
{
	class SOAGEN_EMPTY_BASES planes //
		SOAGEN_HIDDEN_BASE(public soagen::mixins::erasable<planes>,
						   public soagen::mixins::unordered_erasable<planes>,
						   ...
						   public soagen::mixins::swappable<planes>)
	{
	  ...
	  public:
		...
		SOAGEN_HIDDEN(template <bool sfinae = table_traits::rvalue_type_list_is_distinct>)
		SOAGEN_CPP20_CONSTEXPR
		SOAGEN_ENABLE_IF_T(planes&, sfinae)
		push_back(column_traits<0>::rvalue_type value,
				  column_traits<1>::rvalue_type material,
		...
		template <typename Table, size_t... Columns SOAGEN_ENABLE_IF(soagen::is_soa<soagen::remove_cvref<Table>>)>
		SOAGEN_CPP20_CONSTEXPR
		planes& emplace_back(const soagen::row<Table, Columns...>& row_)										  //
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>)										  //
		{
		...
		SOAGEN_CPP20_CONSTEXPR
		planes& insert(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_,
					   column_traits<0>::param_type value,
					   column_traits<1>::param_type material,
					   column_traits<2>::param_type normal_x,
					   column_traits<3>::param_type normal_y,
		...
		SOAGEN_CPP20_CONSTEXPR
		planes& insert(size_type index_,
					   SOAGEN_ENABLE_IF_T(column_traits<0>::rvalue_type, sfinae) value,
					   column_traits<1>::rvalue_type material,
					   column_traits<2>::rvalue_type normal_x,
					   column_traits<3>::rvalue_type normal_y,
		...
		SOAGEN_CPP20_CONSTEXPR
		planes& insert(const_iterator iter_,
					   column_traits<0>::rvalue_type value,
					   SOAGEN_ENABLE_IF_T(column_traits<1>::rvalue_type, sfinae) material,
					   column_traits<2>::rvalue_type normal_x,
					   column_traits<3>::rvalue_type normal_y,
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		planes& insert(const_iterator iter_, const soagen::row<Table, Columns...>& row_)						 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		template <typename Value,
				  ...
				  bool sfinae = table_traits::all_move_constructible&& table_traits::all_move_assignable>
		SOAGEN_CPP20_CONSTEXPR
		planes& emplace(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_,
						Value&& value,
						Material&& material,
						NormalX&& normal_x,
						NormalY&& normal_y,
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		planes& emplace(size_type index_, const soagen::row<Table, Columns...>& row_)							 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		planes& emplace(const_iterator iter_, const soagen::row<Table, Columns...>& row_)						 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
...
namespace rt
{
	class SOAGEN_EMPTY_BASES spheres //
		SOAGEN_HIDDEN_BASE(public soagen::mixins::erasable<spheres>,
						   public soagen::mixins::unordered_erasable<spheres>,
						   ...
						   public soagen::mixins::swappable<spheres>)
	{
	  ...
	  public:
		...
		SOAGEN_HIDDEN(template <bool sfinae = table_traits::rvalue_type_list_is_distinct>)
		SOAGEN_CPP20_CONSTEXPR
		SOAGEN_ENABLE_IF_T(spheres&, sfinae)
		push_back(column_traits<0>::rvalue_type value,
				  column_traits<1>::rvalue_type material,
				  column_traits<2>::rvalue_type center_x,
				  column_traits<3>::rvalue_type center_y,
		...
		template <typename Table, size_t... Columns SOAGEN_ENABLE_IF(soagen::is_soa<soagen::remove_cvref<Table>>)>
		SOAGEN_CPP20_CONSTEXPR
		spheres& emplace_back(const soagen::row<Table, Columns...>& row_)										  //
			noexcept(noexcept(
				std::declval<table_type&>().emplace_back(std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>)										  //
		{
		...
		SOAGEN_CPP20_CONSTEXPR
		spheres& insert(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_,
						column_traits<0>::param_type value,
						column_traits<1>::param_type material,
						column_traits<2>::param_type center_x,
						column_traits<3>::param_type center_y,
		...
		SOAGEN_CPP20_CONSTEXPR
		spheres& insert(size_type index_,
						SOAGEN_ENABLE_IF_T(column_traits<0>::rvalue_type, sfinae) value,
						column_traits<1>::rvalue_type material,
						column_traits<2>::rvalue_type center_x,
						column_traits<3>::rvalue_type center_y,
		...
		SOAGEN_CPP20_CONSTEXPR
		spheres& insert(const_iterator iter_,
						column_traits<0>::rvalue_type value,
						SOAGEN_ENABLE_IF_T(column_traits<1>::rvalue_type, sfinae) material,
						column_traits<2>::rvalue_type center_x,
						column_traits<3>::rvalue_type center_y,
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		spheres& insert(const_iterator iter_, const soagen::row<Table, Columns...>& row_)						 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		template <typename Value,
				  ...
				  bool sfinae = table_traits::all_move_constructible&& table_traits::all_move_assignable>
		SOAGEN_CPP20_CONSTEXPR
		spheres& emplace(SOAGEN_ENABLE_IF_T(const_iterator, sfinae) iter_,
						 Value&& value,
						 Material&& material,
						 CenterX&& center_x,
						 CenterY&& center_y,
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		spheres& emplace(size_type index_, const soagen::row<Table, Columns...>& row_)							 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
		...
		template <typename Table,
				  size_t... Columns SOAGEN_ENABLE_IF(
					  soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
						  table_traits::all_move_assignable)>
		SOAGEN_CPP20_CONSTEXPR
		spheres& emplace(const_iterator iter_, const soagen::row<Table, Columns...>& row_)						 //
			noexcept(noexcept(std::declval<table_type&>()
								  .emplace(size_type{}, std::declval<const soagen::row<Table, Columns...>&>()))) //
			SOAGEN_REQUIRES(soagen::is_soa<soagen::remove_cvref<Table>>&& table_traits::all_move_constructible&&
								table_traits::all_move_assignable)												 //
