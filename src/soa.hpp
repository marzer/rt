...
namespace rt
{
	...
	class boxes
	{
	  ...
	  public:
		...
		{
			static constexpr size_type material = 0;
			...
			static constexpr size_type extents_x = 4;

			static constexpr size_type extents_y = 5;

			static constexpr size_type extents_z = 6;
		};
	  ...
	  private:
		...
		// clang-format off
			...
			template <> struct column_name_<0>{  static constexpr auto value = "material"; };
			...
			template <> struct column_name_<4>{  static constexpr auto value = "extents_x"; };

			template <> struct column_name_<5>{  static constexpr auto value = "extents_y"; };

			template <> struct column_name_<6>{  static constexpr auto value = "extents_z"; };
	  ...
	  public:
		...
		SOAGEN_ALWAYS_INLINE
		SOAGEN_CPP20_CONSTEXPR
		boxes& push_back(column_traits<0>::param_type material,
						 column_traits<1>::param_type center_x,
						 column_traits<2>::param_type center_y,
						 column_traits<3>::param_type center_z,
						 column_traits<4>::param_type extents_x,
						 column_traits<5>::param_type extents_y,
						 column_traits<6>::param_type extents_z) //
		...
		{
			table_.emplace_back(static_cast<column_traits<0>::param_type&&>(material),
								...
								static_cast<column_traits<4>::param_type&&>(extents_x),
								static_cast<column_traits<5>::param_type&&>(extents_y),
								static_cast<column_traits<6>::param_type&&>(extents_z));
			return *this;
		}
		...
		SOAGEN_ALWAYS_INLINE
		SOAGEN_CPP20_CONSTEXPR
		boxes& emplace_back(soagen::emplacer<Material...>&& material,
		...
		{
			table_.emplace_back(static_cast<soagen::emplacer<Material...>&&>(material),
		...
		/// @brief Returns a pointer to the elements in column [0]: material.
		SOAGEN_ALIGNED_COLUMN(0)
		...
		/// @brief Returns a pointer to the elements in column [1]: center_x.
		...
		/// @brief Returns a pointer to the elements in column [2]: center_y.
		...
		/// @brief Returns a pointer to the elements in column [3]: center_z.
		...
		/// @brief Returns a pointer to the elements in column [4]: extents_x.
		...
		/// @brief Returns a pointer to the elements in column [5]: extents_y.
		...
		/// @brief Returns a pointer to the elements in column [6]: extents_z.
